...
export default function NewGameForm({ onEnded }: Props) {
  ...
  function reset() {
    setFunnel({
      ...funnel,
      version: shootoutConfig.version,
      questions: {
        name1: 'Player 1',
        name2: 'Player 2',
...
const steps: any = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        _uid: 'shootout-fm-3',
        type: 'number',
        error: 'Définir la durée totale de la partie',
        label: 'Durée totale de la partie (min.)',
      ...
      },
      {
        ...
        _uid: 'shootout-fm-5',
        type: 'number',
        error: 'Définir changement de durée du shot',
        label: 'Changement de durée du shot (min)',
      ...
      },
      {
        ...
        label: 'Durée du shot en 2e période (sec)',
