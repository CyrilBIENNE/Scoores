  ...
  return (
    ...
    >
      <path
        ...
        d="M28,55.4c-0.4-1.2-0.8-2.3-1.3-3.5c-0.7-1.9-1.5-4.8-3.3-7.8c-0.9-1.4-1.5-2.3-2.8-3.4
	...
	c-0.4,2.9-0.2,5.8,0.6,8.7c0.6,2,1.5,3.8,2.3,5.6c2,4.6,4.3,9.2,6.1,13.9c1.3,3.3,2.3,5.9,3,9.4C27.9,54.5,28,55.4,28,55.4z"
      ...
      <path
        fill={color ?? 'currentColor'}
        d="M12,29.2c0.4,0.8,0.8,1.5,1.2,2.3c1.3,2.9,2.4,5.8,3.1,8.8c0.4,1.8,0.7,2.9,0.9,5.2c0.1,0.3,0.1,1.3,0,1.3
	...
	C12.9,31.8,11.9,29.3,12,29.2z"
      ...
      <path
        fill={color ?? 'currentColor'}
        d="M10.6,11.6c0,0-0.7,1.3-1,2.1c-0.8,1.9-0.9,3.9-0.7,5.9c0.2,2.6,1.1,5.1,1.7,7.6c0.3,1.6,0.8,3.1,0.7,4.7
	...
	c-0.2-1.5-0.3-3-0.2-4.5c0.2-2.7,0.4-5.3,1.4-7.8C9.5,12.9,10.6,11.6,10.6,11.6z"
      ...
      <path
        fill={color ?? 'currentColor'}
        d="M31,36.3c-0.5-4.1-2.6-7-6.1-9c-0.1-0.1-0.3-0.1-0.4-0.2c0,0,0.2,0.6,0.2,0.8c0.2,0.9-0.1,1.8-1,2.4
